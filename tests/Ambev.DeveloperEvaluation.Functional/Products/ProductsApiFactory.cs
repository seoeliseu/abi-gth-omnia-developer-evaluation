using Ambev.DeveloperEvaluation.Products.WebApi.Controllers;
...
public sealed class ProductsApiFactory : WebApplicationFactory<ProductsController>, IAsyncLifetime
{
    private const string DatabaseName = "developer-evaluation-products-functional";
    ...
    private readonly PostgreSqlContainer _postgreSqlContainer = new PostgreSqlBuilder("postgres:15.1")
        .WithDatabase("developer_evaluation_products_functional")
    ...
    public async Task InitializeAsync()
    {
        ...
        var settings = new Dictionary<string, string?>
        {
            ...
            ["RabbitMq__QueueName"] = "developer-evaluation.products.functional"
        };
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configurationBuilder) =>
        {
            var settings = new Dictionary<string, string?>
            {
                ...
                ["RabbitMq:QueueName"] = "developer-evaluation.products.functional"
            };
