using Ambev.DeveloperEvaluation.Users.WebApi.Controllers;
...
public sealed class UsersApiFactory : WebApplicationFactory<UsersController>, IAsyncLifetime
{
    private const string DatabaseName = "developer-evaluation-users-functional";
    ...
    private readonly PostgreSqlContainer _postgreSqlContainer = new PostgreSqlBuilder("postgres:15.1")
        .WithDatabase("developer_evaluation_users_functional")
    ...
    public async Task InitializeAsync()
    {
        ...
        var settings = new Dictionary<string, string?>
        {
            ...
            ["RabbitMq__QueueName"] = "developer-evaluation.users.functional"
        };
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configurationBuilder) =>
        {
            var settings = new Dictionary<string, string?>
            {
                ...
                ["RabbitMq:QueueName"] = "developer-evaluation.users.functional"
            };
